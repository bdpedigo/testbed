...
# # plot vertices on bbox surface in red
...
# # plot vertices on ANY chunk boundary in red
# bbox = node_bbox(node_id, cv)
# vertices_on_boundaries = vertices_on_chunk_boundaries(mesh[0], bbox, cv)
# box = pv.Box(bounds=bbox.T.flatten().tolist())
# plotter = pv.Plotter()
# plotter.add_mesh(pv.make_tri_mesh(*mesh), color="lightgray")
# plotter.add_mesh(box, color="black", opacity=1, style="wireframe")
...
plotter.add_points(mesh[0][loop_vertices[~loop_on_boundary]], color="blue", point_size=10)
